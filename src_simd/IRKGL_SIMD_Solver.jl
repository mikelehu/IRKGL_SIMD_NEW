...
function DiffEqBase.__solve(prob::DiffEqBase.AbstractODEProblem{uType,tType,isinplace},
    ...
    irkgl_cache = IRKGL_SIMD_Cache(f,p,b,c,mu,nu,nu1,nu2,theta,omega,alpha,g,d,s_beta,
                                   U, U_, L, dU,
        ...
        while cont
            ...
            for i in 1:m
                ...
                if (irkgl_cache.step_number[] ==1)
                    ...
                    (status,j_iter) = IRKGLstep_SIMD_fixed!(tj,tj1, uj,ej,prob,dts,irkgl_cache)
                    ...
                    (status,j_iter) = IRKGLstep_SIMD_adap!(tj,tj1, uj,ej,prob,dts,irkgl_cache)
                end
